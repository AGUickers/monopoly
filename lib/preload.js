...
(this.createjs = this.createjs || {}),
    ...
    (b.LOAD_TIMEOUT_DEFAULT = 8e3),
      (b.create = function (a) {
        ...
        if (a instanceof Object && a.src)
          return (
            null == a.loadTimeout && (a.loadTimeout = b.LOAD_TIMEOUT_DEFAULT), a
          );
  ...
  (function () {
    ...
    (a.load = function () {
      ...
      (createjs.MediaTagRequest = createjs.promote(
        MediaTagRequest,
        "TagRequest"
      ));
  })(),
    ...
    (a.init = function (a, b, c) {
      ...
      (a.loadManifest = function (a, c, d) {
        ...
        if (Array.isArray(a)) {
          ...
          e = a;
        } else if ("string" == typeof a) e = [{ src: a, type: b.MANIFEST }];
        else {
          if ("object" != typeof a) {
  ...
  (function () {
    ...
    (b.canLoadItem = function (a) {
      ...
      (createjs.BinaryLoader = createjs.promote(
        BinaryLoader,
        "AbstractLoader"
      ));
  })(),
  ...
  (function () {
    ...
    (FontLoader.canLoadItem = function (a) {
      ...
      (a._watch = function () {
        ...
        if (c !== a.length) {
          var i = new createjs.ProgressEvent(
      ...
      (a._calculateReferenceSizes = function (a) {
        for (
          var b = FontLoader._referenceFonts, c = (a.refs = []), d = 0;
          d < b.length;
          d++
        )
      ...
      (a._defFromSrc = function (a) {
        ...
        (b = d.search(/[?#]/)),
          -1 !== b && (d = d.substr(0, b)),
          (b = d.lastIndexOf(".")),
          -1 !== b && ((e = d.substr(b + 1)), (d = d.substr(0, b))),
          (b = d.lastIndexOf("/")),
          -1 !== b && (d = d.substr(b + 1));
        var f = d,
        ...
        g &&
          ((g = g[0]),
          (f = f.replace(g, "")),
          (g = g.replace(c, "").toLowerCase()));
        var h = d.match(FontLoader.STYLE_REGEX);
        h && ((f = f.replace(h[0], "")), (h = "italic")),
          (f = f.replace(c, ""));
      ...
      (a._getTextWidth = function (a, b, c) {
        ...
        return (
          (d.font = c + " " + b + " 72px " + a),
          d.measureText(FontLoader.sampleText).width
        );
      }),
  ...
  (function () {
    ...
    (b.MANIFEST_PROGRESS = 0.25),
      ...
      (a._handleManifestProgress = function (a) {
        (this.progress =
          a.progress * (1 - b.MANIFEST_PROGRESS) + b.MANIFEST_PROGRESS),
      ...
      (createjs.ManifestLoader = createjs.promote(
        ManifestLoader,
        "AbstractLoader"
      ));
  })(),
  ...
  (function () {
    ...
    (b.canLoadItem = function (a) {
      ...
      (createjs.SoundLoader = createjs.promote(
        SoundLoader,
        "AbstractMediaLoader"
      ));
  })(),
  ...
  (function () {
    ...
    (a._createTag = function () {
      ...
      (createjs.VideoLoader = createjs.promote(
        VideoLoader,
        "AbstractMediaLoader"
      ));
  })(),
  ...
  (function () {
    ...
    (b.SPRITESHEET_PROGRESS = 0.25),
      ...
      (a._handleManifestProgress = function (a) {
        (this.progress =
          a.progress * (1 - b.SPRITESHEET_PROGRESS) + b.SPRITESHEET_PROGRESS),
          this._sendProgress(this.progress);
      }),
      (a._handleManifestError = function (a) {
        var b = new createjs.Event("fileerror");

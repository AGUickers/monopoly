...
export function playMusic( music, looped ) {
    var music = new Audio("../assets/" + music);
    music.loop = looped;
    music.play();
    return music;
}
...
export function checkConnection() {
    var networkstatus = navigator.onLine;
    console.log(networkstatus);
    if (networkstatus == false) {
      displayMessageBox("It appears you're offline. Please check your internet connection.", messageBoxType.OK);
    }
}
